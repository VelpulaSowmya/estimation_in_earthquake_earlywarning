...
ROOT_URLCONF = 'estimation_in_earthquake_earlywarning.urls'
...
WSGI_APPLICATION = 'estimation_in_earthquake_earlywarning.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'estimation_in_earthquake_earlywarning',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
