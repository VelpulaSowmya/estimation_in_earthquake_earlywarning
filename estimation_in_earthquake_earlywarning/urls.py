...
urlpatterns = [
    ...
    url(r'^Predict_Earthquake_Early_Warning_Prediction/$', remoteuser.Predict_Earthquake_Early_Warning_Prediction, name="Predict_Earthquake_Early_Warning_Prediction"),
    ...
    url(r'^View_Prediction_Of_Earthquake_Early_Warning_Ratio/$', serviceprovider.View_Prediction_Of_Earthquake_Early_Warning_Ratio, name="View_Prediction_Of_Earthquake_Early_Warning_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Earthquake_Early_Warning/$', serviceprovider.View_Prediction_Of_Earthquake_Early_Warning, name="View_Prediction_Of_Earthquake_Early_Warning"),
